...
- [x] 1. Créer une branche Git et backup de sécurité
...
- [x] 2. Analyser et documenter la structure du CRM source
...
- [x] 2.1 Créer le mapping MongoDB → Prisma
...
- [x] 2.2 Identifier les composants existants dans alfi-crm
...
- [x] 2.3 Créer la structure de documentation
...
- [x] 3.1 Créer les composants Bento spécialisés
...
- [x] 3.2 Créer le template ChartHero
...
- [x] 3.3 Créer le template DualCharts
...
- [x] 3.4 Créer le template Timeline
...
- [x] 3.5 Configurer le responsive behavior
...
- [x] 3.6 Implémenter l'accessibilité
...
- [x] 3.7 Écrire les tests des composants Bento
...
- [x] 4. Migrer les utilitaires de base
...
- [x] 4.1 Créer les services Prisma
...
- [x] 4.2 Migrer les hooks personnalisés
...
- [x] 5. Migrer les composants UI génériques
...
- [x] 5.1 Migrer les composants de formulaires
...
- [x] 5.2 Migrer les composants de tableaux
...
- [x] 5.3 Migrer les composants de graphiques
...
## Phase 5: Migration des API Routes

- [x] 6. Migrer les routes API clients
...
- [x] 6.2 Adapter POST /api/clients
...
- [x] 6.3 Adapter PUT /api/clients/[id]
...
- [x] 6.4 Adapter DELETE /api/clients/[id]
...
:;p
pp- [x] 13. Migrer les calculateurs fiscaux simples avec Chart Hero
...
- [x] 11.1 Migrer les pages calculateurs
...
- [x] 12. Migrer les simulateurs retraite avec Timeline Template
...
- [x] 12.1 Migrer les pages simulateurs retraite
  - Copier les pages simulateurs retraite
  - Adapter les appels API
  - Tester les simulations
  - _Requirements: 5.1, 5.2, 5.5_

- [x] 13. Migrer les simulateurs succession avec Timeline Template
...
- [x] 13.1 Migrer les pages simulateurs succession
  - Copier les pages simulateurs succession
  - Adapter les appels API
  - Tester les simulations
  - _Requirements: 5.1, 5.2, 5.5_

- [x] 14. Migrer les calculateurs complexes avec Dual Charts
...
- [x] 15. Créer les routes API pour sauvegarder les simulations
...
- [x] 16. Migrer la page dashboard principale avec Bento Grid
...
- [x] 16.1 Migrer le layout dashboard complet
  - Migrer la Navigation Sidebar complète avec toutes les sections
  - Migrer la Top Bar avec GlobalSearch, CommandPalette, QuickActions
  - Intégrer QueryClientProvider pour React Query
  - Implémenter les raccourcis clavier (Ctrl+N, Ctrl+K, Ctrl+H)
  - Ajouter le chargement des compteurs temps réel (refresh 30s)
  - Créer/migrer GlobalSearch component
  - Créer/migrer QuickActions modal
  - Intégrer CommandPalette et NotificationCenter existants
  - Implémenter le Mode Présentation avec overlay
  - Adapter ServicesSidebar avec stats contextuelles
  - Tester tous les raccourcis et interactions
  - _Requirements: 2.1, 2.2, 2.4, 2.5, 13.1, 13.2_

- [x] 17. Migrer les pages clients
...
- [x] 18.3 Adapter TabWealth avec Bento Grid
...
- [x] 18.6 Adapter TabOpportunities
...
- [x] 22. Migrer les pages tâches et agenda
...
- [x] 23. Migrer les composants d'export
...
- [x] 23.1 Adapter les routes API d'export
...
- [x] 24. Migrer le système de notifications
...
- [x] 25. Migrer la gestion des documents
...
- [x] 26. Migrer l'authentification
...
- [x] 31. Nettoyer les dépendances MongoDB
...
- [x] 27. Migrer l'interface SuperAdmin
...
- [x] 27.1 Adapter les routes API SuperAdmin
...
- [x] 27.2 Adapter les composants SuperAdmin
...
- [x] 28.1 Migrer les pages du portail client
...
- [x] 28.2 Adapter les routes API Client
...
- [x] 28.3 Implémenter les permissions Client
