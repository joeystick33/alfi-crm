...
Interface de gestion super administrateur pour Aura CRM.
...
**Usage:**
```tsx
import SuperAdminDashboard from '@/app/(superadmin)/(frontend)/components/SuperAdminDashboard';
...
**Usage:**
```tsx
import CreateOrganizationModal from '@/app/(superadmin)/(frontend)/components/CreateOrganizationModal';
...
|------|-------|---------|---------|-------------|
| TRIAL | 2 | 50 | 1 GB | 0 |
| STARTER | 3 | 150 | 5 GB | 0 |
| BUSINESS | 10 | 500 | 20 GB | 0 |
| PREMIUM | ∞ | ∞ | 100 GB | ∞ |
...
|------|------|-----------------|
| TRIAL | 0€ (14 jours) | Découverte CRM |
| STARTER | 59€/mois | CRM complet |
| BUSINESS | 99€/mois | CRM + Calculateurs fiscaux |
| PREMIUM | 199€/mois | CRM + Calculateurs + Simulateurs (Accès complet) |
