...
const BAREME_IFI_DISPLAY = { SEUIL_IMPOSITION: 1300000 }
const PRELEVEMENTS_SOCIAUX_DISPLAY = { TAUX_GLOBAL: 17.2 }
          ...
          {!showResults ? (
            <div className="sim-card">
              ...
              <div className="flex justify-between mt-8">
                ...
                {step < 6 ? <button onClick={()=>setStep(step+1)} className="btn-primary">Suivant →</button> : <button onClick={lancerSimulation} disabled={loading} className="btn-primary">{loading?'⏳':'🧮 Analyser'}</button>}
              </div>
            </div>
          ) : synthese && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="sim-card">
                ...
                <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <h4 className="font-semibold text-blue-800 mb-2">📊 Comprendre la fiscalité SCPI</h4>
              ...
              <div className="sim-card bg-gradient-to-br from-slate-800 to-slate-900 text-white">
                <h3 className="font-bold mb-4 text-lg">💼 Avis professionnel sur l'investissement SCPI</h3>
                <div className="text-sm space-y-3 text-slate-200">
                  {typeAcquisition === 'NUE_PROPRIETE' ? (
                    ...
                    <p><strong className="text-amber-400">⚠️ Performance modeste</strong> : TRI de {fmtPct(synthese.tri)} en dessous de la moyenne. Vérifiez les frais et comparez avec d'autres SCPI.</p>
                  )}
