 ...
 * 
 * Les valeurs fiscales centralisées proviennent de fiscal-rules.ts (RULES).
 */
...
export const LOCATION_NUE = {
  // Micro-foncier (CGI art. 32) — Source : RULES.immobilier.micro_foncier
  MICRO_FONCIER: {
  ...
  // Déficit foncier (CGI art. 156-I-3°) — Source : RULES.immobilier.deficit_foncier
  DEFICIT_FONCIER: {
...
export const PLUS_VALUE_IMMOBILIERE = {
  // Taux d'imposition (CGI art. 200 B) — Source : RULES.immobilier.plus_value
...
// ============================================================================
// BARÈME IR — Source : RULES.ir
// ============================================================================
export const BAREME_IR_2025 = {
  TRANCHES: RULES.ir.bareme.map(t => ({
    min: t.min,
    max: t.max,
    taux: t.taux * 100,
  })),
  PLAFOND_QF: RULES.ir.quotient_familial.plafond_demi_part,
  DECOTE: {
    CELIBATAIRE: { seuil: RULES.ir.decote.seuil_celibataire, max: RULES.ir.decote.base_celibataire },
    COUPLE: { seuil: RULES.ir.decote.seuil_couple, max: RULES.ir.decote.base_couple },
  },
}
...
export const BAREME_IFI = {
  ...
  DECOTE: {
    SEUIL_MIN: RULES.ifi.seuil_assujettissement,
    SEUIL_MAX: RULES.ifi.decote.seuil,
    FORMULE: `${RULES.ifi.decote.base} - ${RULES.ifi.decote.taux * 100}% × patrimoine`
  }
}
...
// ============================================================================
// PLAFOND NICHES — Source : RULES.ir
// ============================================================================
export const PLAFOND_NICHES = {
  PLAFOND_GLOBAL: RULES.ir.plafond_niches_fiscales,
  PLAFOND_OUTREMER: RULES.ir.plafond_niches_outremer,
