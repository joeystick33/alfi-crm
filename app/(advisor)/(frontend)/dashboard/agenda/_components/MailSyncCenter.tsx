...
import { MailSyncModal } from "./MailSyncModal";
...
export function MailSyncCenter() {
              ...
              {connectedCount > 0 && (
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200 mt-3">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-slate-500">Sync automatique</span>
                    <span className="text-slate-700 font-medium">Toutes les 5 min</span>
                  </div>
                </div>
              )}
            </>
