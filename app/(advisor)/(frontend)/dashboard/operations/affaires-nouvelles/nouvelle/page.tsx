...
// ============================================================================
// Mock Client Data (to be replaced with real API)
// ============================================================================

const MOCK_CLIENTS = [
  { id: 'client-1', name: 'Jean Dupont', email: 'jean.dupont@email.com', kycStatus: 'VALID' },
  { id: 'client-2', name: 'Marie Martin', email: 'marie.martin@email.com', kycStatus: 'VALID' },
  { id: 'client-3', name: 'Pierre Bernard', email: 'pierre.bernard@email.com', kycStatus: 'EXPIRED' },
  { id: 'client-4', name: 'Sophie Petit', email: 'sophie.petit@email.com', kycStatus: 'INCOMPLETE' },
]
...
export default function NouvelleAffairePage() {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 0:
        return <ClientStep formData={formData} setFormData={updateFormData} />
      case 1:
