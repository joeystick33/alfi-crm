/**
 * ══════════════════════════════════════════════════════════════════════════════
 * PARAMÈTRES FISCAUX IR 2025 (revenus 2024)
 * ══════════════════════════════════════════════════════════════════════════════
 * 
 * Ce fichier centralise tous les paramètres fiscaux pour le simulateur IR.
...
export const BAREME_IR_2025 = [
  { min: 0, max: 11497, taux: 0, label: 'Non imposable' },
  { min: 11497, max: 29315, taux: 11, label: 'Tranche 11%' },
  { min: 29315, max: 83823, taux: 30, label: 'Tranche 30%' },
  { min: 83823, max: 180294, taux: 41, label: 'Tranche 41%' },
  { min: 180294, max: Infinity, taux: 45, label: 'Tranche 45%' },
] as const
...
export const QUOTIENT_FAMILIAL_2025 = {
  ...
  PLAFOND_DEMI_PART: 1759,           // Avantage max par demi-part supplémentaire
  PLAFOND_QUART_PART: 879.50,        // Pour garde alternée
  PLAFOND_PARENT_ISOLE: 4149,        // 1ère demi-part parent isolé (case T)
...
export const DECOTE_2025 = {
  SEUL: {
    SEUIL: 1929,      // IR en dessous duquel la décote s'applique
...
export const PLAFOND_NICHES_2025 = {
  GENERAL: 10000,                    // Plafond général
  MAJORE: 18000,                     // Avec SOFICA ou investissements outre-mer
...
export const CHARGES_DEDUCTIBLES_2025 = {
  ...
  // Épargne retraite PER - CGI art. 163 quatervicies
  PER: {
    TAUX_PLAFOND: 10,                // % du revenu N-1
    PLAFOND_ABSOLU: 35194,           // 10% de 8 PASS
    PLANCHER: 4399,                  // 10% du PASS
    PASS_2024: 46368,                // Plafond Annuel Sécurité Sociale
    MUTUALISATION_COUPLE: true,      // Possibilité de mutualiser les plafonds
    REPORT_3_ANS: true,              // Report des plafonds non utilisés
  },
  
  // CSG déductible
  CSG_DEDUCTIBLE: {
    TAUX: 6.8,                       // Sur revenus du patrimoine
    CONDITIONS: 'Revenus du patrimoine de l\'année N-1',
  },
  
  // Déficit foncier
  DEFICIT_FONCIER: {
    IMPUTABLE_RG: 10700,             // Imputable sur revenu global
...
export const PFU_2025 = {
  TAUX_GLOBAL: 30,                    // IR 12.8% + PS 17.2%
  TAUX_IR: 12.8,
  TAUX_PS: 17.2,
...
export const PRELEVEMENTS_SOCIAUX_2025 = {
  ...
  CSG_DEDUCTIBLE: 6.8,               // Déductible l'année suivante
