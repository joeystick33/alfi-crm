/**
 * ══════════════════════════════════════════════════════════════════════════════
 * PARAMÈTRES FISCAUX PLUS-VALUES 2025
 * ══════════════════════════════════════════════════════════════════════════════
 * 
 * Ce fichier centralise tous les paramètres fiscaux pour le calculateur de PV.
...
// ══════════════════════════════════════════════════════════════════════════════
// PRÉLÈVEMENTS SOCIAUX - Commun à tous les régimes
// ══════════════════════════════════════════════════════════════════════════════
export const PRELEVEMENTS_SOCIAUX = {
  ...
  CSG_DEDUCTIBLE: 6.8,  // Déductible si option barème
} as const
...
export function calculerPVObjetsPrecieux(
  ...
  if (prixAcquisition !== null && prixAcquisition > 0) {
    ...
    if (pvBrute > 0) {
      ...
      const ir = pvImposable * 19 / 100
      const ps = pvImposable * 17.2 / 100
