...
```tsx
// aura-crm/app/dashboard/clients/page.tsx
'use client'
...
```tsx
// aura-crm/components/client360/TabWealth.tsx
'use client'
...
```tsx
// aura-crm/components/client360/TabDocuments.tsx
'use client'
...
```tsx
// aura-crm/components/client360/TabReporting.tsx
'use client'
