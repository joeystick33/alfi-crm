...
export function SuccessionComparison() {
  ...
  const compareStrategies = async () => {
    ...
    try {
      const response = await fetch('/api/advisor/simulators/succession/compare', {
        method: 'POST',
      ...
      setResult(payload.comparison || payload.data || payload.result);
    } catch (err: unknown) {
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <Input
                ...
                type="number"
                value={estateValue}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEstateValue(e.target.value)}
                placeholder="1000000"
              />
            </div>
                      ...
                      <div className="flex items-start gap-3">
                        <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-3">
                          <Input
                            ...
                            type="text"
                            value={heir.name}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateHeir(heir.id, 'name', e.target.value)}
                          ...
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => updateHeir(heir.id, 'relationship', e.target.value)}
                          ...
                          <Input
                            ...
                            type="number"
                            value={heir.share}
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateHeir(heir.id, 'share', e.target.value)}
                            placeholder="50"
                          />
                          ...
                          <Input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => updateHeir(heir.id, 'previousDonations', e.target.value)}
                            placeholder="0"
                          />
                        </div>
