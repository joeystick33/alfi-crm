...
import { NotificationFilters, CreateNotificationPayload } from '@/app/_common/lib/api-types'
export type { NotificationFilters, CreateNotificationPayload }
...
export function normalizeNotificationCreatePayload(body: unknown): CreateNotificationPayload {
  ...
  const userId = ensureString(data.userId, 'userId', true)!
