...
const simulators: SimulatorItem[] = [
  ...
  },
  {
    ...
    category: 'retraite',
    icon: TrendingUp,
    path: '/simulators/retirement-comparison',
  ...
  },
  {
    ...
    category: 'succession',
    icon: Building2,
    path: '/simulators/succession-comparison',
  ...
  },
  {
    ...
    category: 'succession',
    icon: Briefcase,
    path: '/simulators/donation-optimizer',
  ...
  },
  {
    ...
    category: 'fiscalite',
    icon: TrendingUp,
    path: '/simulators/tax-strategy-comparison',
  ...
  },
  {
    ...
    category: 'fiscalite',
    icon: Home,
    path: '/simulators/investment-vehicle-comparison',
