 ...
 */
export function filterConfidentialData<T extends Record<string, unknown>>(
  data: T,
...
export async function logClientPortalAccess(
  clientId: string,
  action: 'CREATION' | 'MODIFICATION' | 'SUPPRESSION' | 'CONSULTATION' | 'EXPORT' | 'PARTAGE' | 'SIGNATURE' | 'APPROBATION' | 'REJET',
  resourceType?: string,
  resourceId?: string,
