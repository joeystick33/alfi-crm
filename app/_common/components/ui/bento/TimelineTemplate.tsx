...
export function TimelineTemplate({
  ...
  const feasibilityColors = {
    FEASIBLE: 'bg-green-500/10 border-green-500/20 text-green-700',
    CHALLENGING: 'bg-yellow-500/10 border-yellow-500/20 text-yellow-700',
    NOT_FEASIBLE: 'bg-red-500/10 border-red-500/20 text-red-700',
  }
