...
import { Button, buttonVariants } from "@/app/_common/components/ui/Button"
import type { ButtonProps } from "@/app/_common/components/ui/Button"
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }: { className?: string; orientation?: string } & React.SVGAttributes<SVGSVGElement>) => {
          if (orientation === "left") {
