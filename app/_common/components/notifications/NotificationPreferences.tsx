...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/app/_common/components/ui/Card'
...
export function NotificationPreferences() {
  ...
  const handleSave = () => {
    // TODO: Save preferences to backend via API
    toast({
