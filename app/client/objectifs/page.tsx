...
export default function ObjectifsPage() {
  const objectifs = [
    {
      id: 1,
      title: 'Achat résidence principale',
      description: 'Acquisition d\'une maison dans les 2 ans',
      target: 400000,
      current: 300000,
      percentage: 75,
      deadline: '2026-06-01',
    ...
    },
    {
      ...
      description: 'Constitution d\'un capital retraite',
      target: 500000,
      current: 150000,
      percentage: 30,
      deadline: '2045-01-01',
    ...
    },
    {
      ...
      description: 'Achat d\'un bien locatif',
      target: 250000,
      current: 180000,
      percentage: 72,
      deadline: '2025-12-01',
