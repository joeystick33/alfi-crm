/**
 * API Route - Cron Job Hebdomadaire
 * POST /api/cron/weekly - Exécuter les tâches hebdomadaires
 * 
...
import { runWeeklyTasks } from '@/lib/services/automation-service';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const results = await runWeeklyTasks();
