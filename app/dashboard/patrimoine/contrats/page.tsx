...
export default function ContratsPage() {
  ...
  const totalValeur = filteredContrats.reduce((sum, contrat) => sum + (contrat.valeur || 0), 0);
  const totalPrimes = filteredContrats.reduce((sum, contrat) => sum + (contrat.primeAnnuelle || 0), 0);
