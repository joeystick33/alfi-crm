...
export const PLAFONDS = {
  ...
  PASS: 47100,  // 2025 (était 46368€ en 2024)
...
export const TRIMESTRES_REQUIS: Record<number, number> = {
  ...
  // 1960 2e semestre et après : réforme 2023
  1961: 169,
  1962: 169,
  1963: 170,
  1964: 171,
...
export const AGE_LEGAL_PAR_GENERATION: Record<number, number> = {
  ...
  1966: 63.5,
  1967: 63.75,
  1968: 64,     // et générations suivantes
}
...
export const AGIRC_ARRCO = {
  /** Valeur du point (liquidation) en € */
  VALEUR_POINT: 1.4386,
  
  /** Prix d'achat du point en € */
  PRIX_ACHAT_POINT: 20.1877,
  ...
  /** Plafond tranche 1 */
  PLAFOND_T1: 47100,  // = 1 PASS
  
  /** Plafond tranche 2 */
  PLAFOND_T2: 376800,  // = 8 PASS
...
export function getAgeLegal(anneeNaissance: number): number {
  if (anneeNaissance >= 1968) return 64
  return AGE_LEGAL_PAR_GENERATION[anneeNaissance] || 64
}
