...
export class EmailSyncService {
   ...
   * Sync Gmail emails
   */
  private async syncGmailEmails(integration: any): Promise<{ synced: number; errors: number }> {
   ...
   * Sync Outlook emails
   */
  private async syncOutlookEmails(integration: any): Promise<{ synced: number; errors: number }> {
