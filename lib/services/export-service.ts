 ...
 */
function translateObject(obj: any): Record<string, any> {
 ...
 */
export function toCSV(data: any[], options: { delimiter?: string } = {}): string {
 ...
 */
export function prepareForExport(data: any[], type: string): any[] {
 ...
 */
export async function exportClients(cabinetId: string, filters?: any) {
