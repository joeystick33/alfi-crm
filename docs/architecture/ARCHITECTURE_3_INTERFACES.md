# 🏗️ Architecture 3 Interfaces - CRM Aura
...
Réorganiser l'architecture du CRM Aura pour **séparer clairement les 3 interfaces**:
...
// Après
import { useClients } from '@/app/_common/hooks/use-api'  // Peut rester identique
