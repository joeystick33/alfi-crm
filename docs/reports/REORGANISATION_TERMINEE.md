...
La réorganisation de l'architecture CRM Aura en **3 interfaces séparées** est **terminée et fonctionnelle**.
...
La réorganisation de l'architecture CRM Aura en **3 interfaces séparées** est **terminée avec succès**.
