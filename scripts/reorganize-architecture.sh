...
# Script de réorganisation de l'architecture CRM ALFI
# Sépare les 3 interfaces: Advisor, Client, SuperAdmin

set -e  # Arrêter en cas d'erreur

echo "🏗️  Réorganisation de l'architecture CRM ALFI"
echo "=============================================="
echo ""
