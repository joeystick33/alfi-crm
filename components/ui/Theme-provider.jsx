...
/**
 * Provider de thème avancé avec support mode sombre dynamique
...
export function ThemeToggle({ className }) {
  ...
  return (
    <motion.button
      ...
      className={`relative inline-flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors ${className}`}
      ...
      {colors.map((color) => (
        <motion.button
          ...
          className={`relative h-8 w-8 rounded-full ${color.value} ${
            accentColor === color.name ? "ring-2 ring-offset-2 ring-slate-900 dark:ring-slate-100" : ""
          }`}
