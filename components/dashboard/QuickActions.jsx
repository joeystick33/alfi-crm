...
export default function QuickActions({ open, onOpenChange }) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[80vh] p-0 gap-0 overflow-hidden">
        <DialogHeader className="px-6 py-4 border-b border-slate-200 dark:border-slate-800">
          <DialogTitle className="text-lg font-bold">Actions rapides</DialogTitle>
          ...
          <div className="px-6 py-4 space-y-6">
                  ...
                  {actions.map((action) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <ArrowRight className="h-5 w-5 text-slate-400 shrink-0 group-hover:translate-x-1 transition-transform" />
                      </motion.button>
                    );
                  })}
                </div>
            ...
            {filteredActions.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-slate-500 font-medium">Aucune action trouvée</p>
        ...
        <div className="px-6 py-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50">
          <div className="flex items-center justify-between text-xs text-slate-500">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-1">
                <kbd className="px-2 py-1 rounded bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 font-mono">
                  ↑↓
                </kbd>
                <span>Naviguer</span>
              </div>
