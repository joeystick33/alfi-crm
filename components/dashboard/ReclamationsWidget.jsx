...
/**
 * Widget Réclamations Urgentes
 * Affiche les réclamations avec SLA critique
 * NOUVEAU - Différenciateur vs concurrents
 */
      ...
      <CardContent className="space-y-3">
        {loading ? (
          <div className="text-center py-6">
            <div className="animate-spin h-6 w-6 border-2 border-red-600 border-t-transparent rounded-full mx-auto"></div>
          </div>
        ) : (
          <>
