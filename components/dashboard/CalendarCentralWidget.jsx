...
export default function CalendarCentralWidget() {
  ...
  const loadEvents = async () => {
    try {
      ...
      // Mock data (à retirer en production)
      const mockEvents = [
        createCalendarEvent({
          id: 'rdv-1',
          type: 'rdv',
          title: '🤝 RDV Martin (PER)',
          start: new Date(2024, 10, 5, 14, 0),
          end: new Date(2024, 10, 5, 15, 0),
          client: { id: 'xxx', name: 'Jean Martin' },
          lieu: 'Bureau',
          notes: 'Présentation PER'
        }),
        createCalendarEvent({
          id: 'rdv-2',
          type: 'rdv',
          ...
          end: new Date(2024, 10, 5, 17, 0),
          client: { id: 'yyy', name: 'Paul Durand' },
          lieu: 'Visio'
        }),
        createCalendarEvent({
          id: 'task-1',
          type: 'task',
          title: '✅ Rappeler Paul Durand',
