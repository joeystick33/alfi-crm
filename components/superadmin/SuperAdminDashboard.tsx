        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">ALFI CRM</h1>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-right ml-4">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Super Administrateur</p>
              </div>
              <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-200 text-sm font-medium rounded">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        {org.status === 'ACTIVE' && (
                          <span className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 text-xs font-medium rounded flex items-center gap-1">
                            <CheckCircle className="w-3 h-3" />
                            Actif
                          </span>
                        )}
                        {org.status === 'TRIALING' && (
                          <span className="px-2 py-1 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200 text-xs font-medium rounded flex items-center gap-1">
                            <Clock className="w-3 h-3" />
                            Essai
                          </span>
                        )}
                        {org.status === 'SUSPENDED' && (
                          <span className="px-2 py-1 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 text-xs font-medium rounded flex items-center gap-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                        <div>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Conseillers</p>
                          <p className="text-lg font-semibold text-gray-900 dark:text-white">
                            {org.advisorsCount || 0}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Clients</p>
                          <p className="text-lg font-semibold text-gray-900 dark:text-white">
                            {org.clientsCount || 0}
                          </p>
                        </div>
                        ...
                        <div>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Créé le</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-gray-700 dark:text-gray-300">Taux d'activation</span>
                <span className="text-2xl font-bold text-green-600">
                  {metrics?.activationRate || 0}%
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-700 dark:text-gray-300">Cabinets actifs</span>
                <span className="text-2xl font-bold text-blue-600">
                  {metrics?.activeOrganizations || 0}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-700 dark:text-gray-300">Moyenne clients/cabinet</span>
