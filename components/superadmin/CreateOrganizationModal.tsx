...
import { X, Building2, AlertCircle, CheckCircle, Copy } from 'lucide-react';
        ...
        <div className="p-6">
          ...
          {step === 3 && createdData && (
            <div className="space-y-4">
              ...
              <div className="p-6 bg-gray-50 dark:bg-gray-700/50 rounded-lg space-y-4">
                <div>
                  <label className="text-xs text-gray-500 dark:text-gray-400">Cabinet</label>
                ...
                <div>
                  <label className="text-xs text-gray-500 dark:text-gray-400">URL de connexion</label>
                  <div className="flex items-center justify-between mt-1">
                ...
                <div>
                  <label className="text-xs text-gray-500 dark:text-gray-400">Mot de passe</label>
                  <div className="flex items-center justify-between mt-1">
                    <span className="font-mono text-sm text-gray-900 dark:text-white">
                      {generatedPassword}
                    </span>
              ...
              <button
                ...
                className="w-full px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 flex items-center justify-center gap-2"
              >
                <Copy className="w-4 h-4" />
