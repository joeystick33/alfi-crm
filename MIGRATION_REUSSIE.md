...
La réorganisation de l'architecture CRM ALFI en **3 interfaces séparées** a été effectuée avec succès.
...
/api/notifications  → /api/advisor/notifications
...
/api/dashboard      → /api/advisor/dashboard
